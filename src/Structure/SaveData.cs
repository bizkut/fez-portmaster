...
public class SaveData
{
  ...
  public bool HasNewGamePlus => this.Finished32 || this.Finished64;
  ...
  public LevelSaveData ThisLevel
  {
    get
    {
      ...
      return this.Level != null && this.World.TryGetValue(this.Level, out levelSaveData) ? levelSaveData : LevelSaveData.Default;
    }
  }
