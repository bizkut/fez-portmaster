...
internal class IntroPanDown(Game game) : GameComponent(game)
{
  ...
  public override void Initialize()
  {
    ...
    this.ePanDown = this.CMProvider.Get(CM.Intro).Load<SoundEffect>("Sounds/Intro/PanDown").Emit(true, true);
  }
