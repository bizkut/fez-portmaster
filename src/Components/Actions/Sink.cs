...
internal class Sink(Game game) : PlayerAction(game)
{
  ...
  protected override void Begin()
  {
    ...
    if (this.LevelManager.WaterType == LiquidType.Lava)
      this.burnSound.EmitAt(this.PlayerManager.Position);
    else if (this.LevelManager.WaterType == LiquidType.Sewer)
      this.drownSound.EmitAt(this.PlayerManager.Position);
  ...
  protected override bool IsActionAllowed(ActionType type) => type == ActionType.Sinking;
}
