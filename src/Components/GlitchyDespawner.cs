...
internal class GlitchyDespawner : DrawableGameComponent
{
  ...
  public override void Initialize()
  {
    ...
    this.FullbrightEffect = (DefaultEffect) textured;
    this.CMProvider.Global.Load<SoundEffect>("Sounds/MiscActors/GlitchyRespawn").EmitAt(this.SpawnMesh.Position);
  ...
  private void Kill() => ServiceHelper.RemoveComponent<GlitchyDespawner>(this);
  ...
  public override void Update(GameTime gameTime)
  {
    ...
    if (this.SinceAlive.TotalSeconds > 2.0 && !this.hasCreatedTreasure && this.CreateTreasure)
    {
      ...
      Trile trile = this.LevelManager.ActorTriles(this.ActorToSpawn).FirstOrDefault<Trile>();
      if (trile != null)
      {
