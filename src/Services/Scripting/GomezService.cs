...
public class GomezService : IGomezService, IScriptingBase
{
  ...
  public event Action CollectedGlobalAnti = new Action(Util.NullAction);
  ...
  public void OnEnterDoor() => this.EnteredDoor();

  public void OnJump() => this.Jumped();

  public void OnClimbLadder() => this.ClimbedLadder();

  public void OnClimbVine() => this.ClimbedVine();

  public void OnLookAround() => this.LookedAround();

  public void OnLiftObject() => this.LiftedObject();

  public void OnThrowObject() => this.ThrewObject();

  public void OnDropObject() => this.DropObject();

  public void OnOpenMenuCube() => this.OpenedMenuCube();

  public void OnReadSign() => this.ReadSign();

  public void OnGrabLedge() => this.GrabbedLedge();

  public void OnHoist() => this.Hoisted();

  public void OnDropLedge() => this.DroppedLedge();

  public void OnClimbOverLadder() => this.ClimbedOverLadder();

  public void OnDropFromLadder() => this.DroppedFromLadder();

  public void OnReadMail() => this.ReadMail();

  public void OnCollectedSplitUpCube() => this.CollectedSplitUpCube();

  public void OnCollectedShard() => this.CollectedShard();

  public void OnOpenTreasure() => this.OpenedTreasure();

  public void OnCollectedPieceOfHeart() => this.CollectedPieceOfHeart();

  public void OnCollectedGlobalAnti() => this.CollectedGlobalAnti();

  public void OnCollectedAnti() => this.CollectedAnti();

  public void OnLand() => this.Landed();

  public int CollectedCubes => this.GameState.SaveData.CubeShards;

  public int CollectedSplits => this.GameState.SaveData.CollectedParts;

  public bool Grounded => this.PlayerManager.Grounded;

  public bool IsOnLadder => this.PlayerManager.Action.IsClimbingLadder();

  public bool CanControl => this.PlayerManager.CanControl;

  public bool Visible => !this.PlayerManager.Hidden;

  public bool Alive
  {
    get
    {
      return this.PlayerManager.Action != ActionType.Dying && this.PlayerManager.Action != ActionType.FreeFalling && this.PlayerManager.Action != ActionType.SuckedIn && this.PlayerManager.Action != ActionType.Sinking;
    }
  }

  public void SetCanControl(bool controllable) => this.PlayerManager.CanControl = controllable;
  ...
  public void SetFezVisible(bool visible) => this.PlayerManager.HideFez = !visible;

  public void SetGomezVisible(bool visible) => this.PlayerManager.Hidden = !visible;
