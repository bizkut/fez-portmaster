...
public abstract class DefaultEffect : BaseEffect
{
  ...
  private DefaultEffect(string effectName)
    : base(effectName)
  {
    this.alphaIsEmissive = new SemanticMappedBoolean(this.effect.Parameters, nameof (AlphaIsEmissive));
    this.fullbright = new SemanticMappedBoolean(this.effect.Parameters, nameof (Fullbright));
    this.emissive = new SemanticMappedSingle(this.effect.Parameters, nameof (Emissive));
  ...
  {
    get => this.alphaIsEmissive.Get();
    set => this.alphaIsEmissive.Set(value);
  }

  public bool Fullbright
  {
    get => this.fullbright.Get();
    set => this.fullbright.Set(value);
  }

  public float Emissive
  {
    get => this.emissive.Get();
    set => this.emissive.Set(value);
  }
  ...
  public class LitVertexColored : DefaultEffect
  {
    ...
    {
      get => this.specularEnabled.Get();
      set => this.specularEnabled.Set(value);
    }
  }
