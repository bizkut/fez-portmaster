...
public class ScriptCondition : ScriptPart, IDeserializationCallback
{
  ...
  public ScriptCondition() => this.Operator = ComparisonOperator.None;

  public override string ToString()
  {
    return $"{(this.Object == null ? "(none)" : this.Object.ToString())}.{this.Property ?? "(none)"} {this.Operator.ToSymbol()} {this.Value}";
  }
  ...
  public void Process()
  {
    ...
    PropertyDescriptor property = type.Properties[this.Property];
    this.processedValue = Convert.ChangeType((object) this.Value, property.Type, (IFormatProvider) CultureInfo.InvariantCulture);
    ...
    if (this.Operator != ComparisonOperator.Equal && this.Operator != ComparisonOperator.NotEqual)
      this.processedNumber = !(this.valueType == typeof (int)) ? (float) this.processedValue : (float) (int) this.processedValue;
    object[] objArray;
    if (!type.Static)
    ...
    this.processedArguments = objArray;
  }
  ...
  public bool Check(IScriptingBase service)
  {
    ...
    switch (this.Operator)
    {
      ...
      case ComparisonOperator.NotEqual:
        return !obj.Equals(this.processedValue);
      default:
        float num = !(this.valueType == typeof (int)) ? (float) obj : (float) (int) obj;
        switch (this.Operator)
        {
