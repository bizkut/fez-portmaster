...
public class Sky
{
  ...
  public Sky ShallowCopy()
  {
    return new Sky()
    {
      ...
      Layers = this.Layers.Select<SkyLayer, SkyLayer>((Func<SkyLayer, SkyLayer>) (x => x.ShallowCopy())).ToList<SkyLayer>(),
  ...
  public void UpdateFromCopy(Sky copy)
  {
    ...
    this.Layers = copy.Layers.Select<SkyLayer, SkyLayer>((Func<SkyLayer, SkyLayer>) (x => x.ShallowCopy())).ToList<SkyLayer>();
