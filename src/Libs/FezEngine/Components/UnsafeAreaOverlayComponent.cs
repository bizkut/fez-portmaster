...
public class UnsafeAreaOverlayComponent : DrawableGameComponent
{
  ...
  {
    get => this.noActionAreaColor;
    set => this.noActionAreaColor = value;
  }

  public Color UnsafeAreaColor
  {
    get => this.unsafeAreaColor;
    set => this.unsafeAreaColor = value;
  }
  ...
  protected override void LoadContent()
  {
    ...
    this.texture.SetData<Color>(new Color[1]{ Color.White });
