...
public static class FezMath
{
  ...
  {
    return FezMath.Saturate(1f - (float) Math.Pow(Math.Pow(-(double) oldFactor + 1.0, 1000.0 / 17.0), (double) dt));
  }
  ...
  public static Vector3 MaxClamp(this Vector3 vector)
  {
    ...
    return (double) vector3.Z >= (double) vector3.X && (double) vector3.Z >= (double) vector3.Y ? new Vector3(0.0f, 0.0f, (float) Math.Sign(vector.Z)) : Vector3.Zero;
  }

  public static Vector3 MaxClampXZ(this Vector3 vector)
  {
    Vector3 vector3 = vector.Abs();
    return (double) vector3.X >= (double) vector3.Z ? new Vector3((float) Math.Sign(vector.X), 0.0f, 0.0f) : new Vector3(0.0f, 0.0f, (float) Math.Sign(vector.Z));
  }
  ...
  {
    return vertex.ComputeTexCoord<T>(Vector3.One);
  }
  ...
  public static Vector2 ComputeTexCoord<T>(this T vertex, Vector3 trileSize) where T : ILitVertex, ITexturedVertex
  {
    ...
    Vector3 b = ((Vector3.One - vertex.Normal.Abs()) * (vertex.Position / trileSize) * 2f + vertex.Normal) / 2f + new Vector3(0.5f);
    float num1 = orientation.AsViewpoint().RightVector().Dot(b);
    float num2 = orientation.AsViewpoint().UpVector().Dot(b);
  ...
  public static float Log(double b, double r) => (float) (Math.Log(b) / Math.Log(r));
  ...
  {
    return FezMath.In<T>(value, value1, value2, comparer) || comparer.Equals(value, value3);
  }
  ...
  {
    return FezMath.In<T>(value, value1, value2, value3, comparer) || comparer.Equals(value, value4);
  }
  ...
  public static bool In<T>(
    ...
    IEqualityComparer<T> comparer)
  {
    return FezMath.In<T>(value, value1, value2, value3, value4, comparer) || comparer.Equals(value, value5);
  }
  ...
  public static bool In<T>(
    ...
    IEqualityComparer<T> comparer)
  {
    return FezMath.In<T>(value, value1, value2, value3, value4, value5, comparer) || comparer.Equals(value, value6);
  }
  ...
  public static bool In<T>(
    ...
    IEqualityComparer<T> comparer)
  {
    return FezMath.In<T>(value, value1, value2, value3, value4, value5, value6, comparer) || comparer.Equals(value, value7);
  }
  ...
  public static bool In<T>(
    ...
    IEqualityComparer<T> comparer)
  {
    return FezMath.In<T>(value, value1, value2, value3, value4, value5, value6, value7, comparer) || comparer.Equals(value, value8);
  }
  ...
  {
    return FezMath.In<T>(value, value1, value2, value3, value4, value5, value6) || value.Equals(value7);
  }
  ...
  public static bool In<T>(
    ...
    where T : IEquatable<T>
  {
    return FezMath.In<T>(value, value1, value2, value3, value4, value5, value6, value7) || value.Equals(value8);
  }
  ...
  public static T Coalesce<T>(T first, T second, IEqualityComparer<T> comparer) where T : struct
  {
    ...
    if (!comparer.Equals(x, first))
      return first;
    return !comparer.Equals(x, second) ? second : x;
  }
  ...
  public static T Coalesce<T>(T first, T second, T third, IEqualityComparer<T> comparer) where T : struct
  {
    ...
    if (!comparer.Equals(x, second))
      return second;
    return !comparer.Equals(x, third) ? third : x;
  }
  ...
  public static T Coalesce<T>(T first, T second) where T : struct, IEquatable<T>
  {
    ...
    if (!first.Equals(other))
      return first;
    return !second.Equals(other) ? second : other;
  }
  ...
  public static T Coalesce<T>(T first, T second, T third) where T : struct, IEquatable<T>
  {
    ...
    if (!second.Equals(other))
      return second;
    return !third.Equals(other) ? third : other;
  }

  public static int Round(double value) => value < 0.0 ? (int) (value - 0.5) : (int) (value + 0.5);
  ...
  public static Vector3 AlmostClamp(Vector3 v) => FezMath.AlmostClamp(v, 1f / 1000f);
  ...
  public static float AlmostClamp(float x, float epsilon)
  {
    ...
    if (FezMath.AlmostEqual(x, 1f, epsilon))
      return 1f;
    return FezMath.AlmostEqual(x, -1f, epsilon) ? -1f : x;
  }

  public static float AlmostClamp(float x) => FezMath.AlmostClamp(x, 1f / 1000f);

  public static bool AlmostEqual(double a, double b, double epsilon) => Math.Abs(a - b) <= epsilon;

  public static bool AlmostEqual(double a, double b) => Math.Abs(a - b) <= 1.0 / 1000.0;
  ...
  public static bool AlmostEqual(float a, float b) => (double) Math.Abs(a - b) <= 1.0 / 1000.0;

  public static bool AlmostEqual(Vector3 a, Vector3 b) => FezMath.AlmostEqual(a, b, 1f / 1000f);

  public static bool AlmostEqual(Vector3 a, Vector3 b, float epsilon)
  {
    return FezMath.AlmostEqual(a.X, b.X, epsilon) && FezMath.AlmostEqual(a.Y, b.Y, epsilon) && FezMath.AlmostEqual(a.Z, b.Z, epsilon);
  }

  public static bool AlmostEqual(Quaternion a, Quaternion b)
  {
    return FezMath.AlmostEqual(a, b, 1f / 1000f);
  }

  public static bool AlmostEqual(Quaternion a, Quaternion b, float epsilon)
  {
    return FezMath.AlmostEqual(a.X, b.X, epsilon) && FezMath.AlmostEqual(a.Y, b.Y, epsilon) && FezMath.AlmostEqual(a.Z, b.Z, epsilon) && FezMath.AlmostEqual(a.W, b.W, epsilon);
  }

  public static bool AlmostEqual(Vector2 a, Vector2 b) => FezMath.AlmostEqual(a, b, 1f / 1000f);

  public static bool AlmostEqual(Vector2 a, Vector2 b, float epsilon)
  {
    return FezMath.AlmostEqual(a.X, b.X, epsilon) && FezMath.AlmostEqual(a.Y, b.Y, epsilon);
  }

  public static bool AlmostWrapEqual(Vector2 a, Vector2 b)
  {
    return FezMath.AlmostWrapEqual(a, b, 1f / 1000f);
  }

  public static bool AlmostWrapEqual(Vector2 a, Vector2 b, float epsilon)
  {
    return FezMath.AlmostWrapEqual(a.X, b.X, epsilon) && FezMath.AlmostWrapEqual(a.Y, b.Y, epsilon);
  }

  public static bool AlmostWrapEqual(float a, float b) => FezMath.AlmostWrapEqual(a, b, 1f / 1000f);
  ...
  public static FaceOrientation OrientationFromPhi(float phi)
  {
    ...
    if (FezMath.AlmostEqual(phi, 1.57079637f))
      return FaceOrientation.Right;
    if (FezMath.AlmostEqual(phi, -3.14159274f))
      return FaceOrientation.Back;
    return FezMath.AlmostEqual(phi, -1.57079637f) ? FaceOrientation.Left : FezMath.OrientationFromPhi(FezMath.SnapPhi(phi));
  }
  ...
  public static Vector3 Slerp(Vector3 from, Vector3 to, float step)
  {
    ...
    if ((double) num1 == -1.0)
    {
      ...
      return (double) step < 0.5 ? FezMath.Slerp(from, vector3, step * 2f) : FezMath.Slerp(vector3, to, (float) (((double) step - 0.5) / 2.0));
    }
  ...
  public static Vector3 GetMask(this Axis axis)
  {
    if (axis == Axis.X)
      return Vector3.UnitX;
    return axis == Axis.Y ? Vector3.UnitY : Vector3.UnitZ;
  }

  public static Vector3 GetMask(this Vector3 vector) => vector.Sign().Abs();
  ...
  {
    theta = (double) theta < -3.1415927410125732 ? (float) (((double) theta - 3.1415927410125732) % 6.2831854820251465 + 3.1415927410125732) : (float) (((double) theta + 3.1415927410125732) % 6.2831854820251465 - 3.1415927410125732);
    return theta;
  }
  ...
  public static bool IsPositive(this Viewpoint view) => view <= Viewpoint.Right;

  public static int AsNumeric(this bool b) => !b ? 0 : 1;
  ...
  {
    return (double) combinedPhi > 0.78539818525314331 && (double) combinedPhi < 2.3561944961547852 || (double) combinedPhi < -0.78539818525314331 && (double) combinedPhi > -2.3561944961547852 ? Axis.X : Axis.Z;
  }
  ...
  {
    return (float) FezMath.Round(0.63661974668502808 * (double) phi) / 0.636619747f;
  }

  public static float Frac(float number) => number - (float) (int) number;

  public static double Frac(double number) => number - (double) (int) number;
  ...
  {
    int distance = toView - fromView;
    if (Math.Abs(distance) == 3)
      distance = Math.Sign(distance) * -1;
    return distance;
  }

  public static Viewpoint GetRotatedView(this Viewpoint fromView, int distance)
  {
    int rotatedView = (int) (fromView + distance);
    while (rotatedView > 4)
      rotatedView -= 4;
    while (rotatedView < 1)
      rotatedView += 4;
    return (Viewpoint) rotatedView;
  }
  ...
  public static Quaternion CatmullRom(
    ...
    float t)
  {
    Vector4 vector4_1 = new Vector4(q0.X, q0.Y, q0.Z, q0.W);
    Vector4 vector4_2 = new Vector4(q1.X, q1.Y, q1.Z, q1.W);
    Vector4 vector4_3 = new Vector4(q2.X, q2.Y, q2.Z, q2.W);
    Vector4 vector4_4 = new Vector4(q3.X, q3.Y, q3.Z, q3.W);
    Vector4 vector4_5 = vector4_2;
    Vector4 vector4_6 = vector4_3;
    Vector4 vector4_7 = vector4_4;
    double amount = (double) t;
    Vector4 vector4_8 = Vector4.CatmullRom(vector4_1, vector4_5, vector4_6, vector4_7, (float) amount);
    return Quaternion.Normalize(new Quaternion(vector4_8.X, vector4_8.Y, vector4_8.Z, vector4_8.W));
  }
