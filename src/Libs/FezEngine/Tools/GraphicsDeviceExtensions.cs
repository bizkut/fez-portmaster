...
public static class GraphicsDeviceExtensions
{
  ...
  public static void SetGamma(this GraphicsDevice device, float brightness)
  {
    ...
    short[] numArray1 = new short[256 /*0x0100*/];
    short[] numArray2 = new short[256 /*0x0100*/];
    short[] numArray3 = new short[256 /*0x0100*/];
  ...
  public static void PrepareStencilWrite(this GraphicsDevice _, FezEngine.Structure.StencilMask? reference)
  {
  ...
  public static void PrepareStencilRead(
    this GraphicsDevice _,
    CompareFunction comparison,
    FezEngine.Structure.StencilMask reference)
  {
    GraphicsDeviceExtensions.dssCombiner.StencilEnable = true;
  ...
  public static void PrepareStencilReadWrite(
    this GraphicsDevice _,
    CompareFunction comparison,
    FezEngine.Structure.StencilMask reference)
  {
  ...
  {
    GraphicsDeviceExtensions.blendCombiner.AlphaBlendFunction = BlendFunction.Add;
    GraphicsDeviceExtensions.blendCombiner.AlphaDestinationBlend = Blend.Zero;
    GraphicsDeviceExtensions.blendCombiner.AlphaSourceBlend = Blend.One;
  }
}
